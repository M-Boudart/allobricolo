                        ...
                        <div class="tab-pane active" id="tabs-1" role="tabpanel">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="listing__item">
                                        ...
                                        data-setbg="{{ asset('template/img/listing/list-1.jpg') }}">
                                            <img src="{{ asset('template/img/listing/list_icon-1.png') }}" alt="">
                                        ...
                                        <div class="listing__item__text">
                                            ...
                                            <div class="listing__item__text__info">
                                                <div class="listing__item__text__info__left">
                                                    <img src="{{ asset('template/img/listing/list_small_icon-1.png') }}" alt="">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="listing__item">
                                        <div class="listing__item__pic set-bg" 
                                        data-setbg="{{ asset('template/img/listing/list-2.jpg') }}">
                                            <img src="{{ asset('template/img/listing/list_icon-2.png') }}" alt="">
                                        ...
                                        <div class="listing__item__text">
                                            ...
                                            <div class="listing__item__text__info">
                                                <div class="listing__item__text__info__left">
                                                    <img src="{{ asset('template/img/listing/list_small_icon-2.png') }}" alt="">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="listing__item">
                                        <div class="listing__item__pic set-bg" 
                                        data-setbg="{{ asset('template/img/listing/list-3.jpg') }}">
                                            <img src="{{ asset('template/img/listing/list_icon-3.png') }}" alt="">
                                            <div class="listing__item__pic__tag">Popular</div>
                                            <div class="listing__item__pic__btns">
                                                <a href="#"><span class="icon_zoom-in_alt"></span></a>
                                                <a href="#"><span class="icon_heart_alt"></span></a>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="listing__item">
                                        <div class="listing__item__pic set-bg" 
                                        data-setbg="{{ asset('template/img/listing/list-4.jpg') }}">
                                            <img src="{{ asset('template/img/listing/list_icon-4.png') }}" alt="">
                                            <div class="listing__item__pic__tag">Popular</div>
                                            <div class="listing__item__pic__btns">
                                                <a href="#"><span class="icon_zoom-in_alt"></span></a>
                                                <a href="#"><span class="icon_heart_alt"></span></a>
                                        ...
                                        <div class="listing__item__text">
                                            ...
                                            <div class="listing__item__text__info">
                                                <div class="listing__item__text__info__left">
                                                    <img src="{{ asset('template/img/listing/list_small_icon-3.png') }}" alt="">
                                                    <span>Hotel</span>
                                                </div>
                                                <div class="listing__item__text__info__right closed">Closed</div>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="listing__item">
                                        <div class="listing__item__pic set-bg"
                                        data-setbg="{{ asset('template/img/listing/list-5.jpg') }}">
                                            <img src="{{ asset('template/img/listing/list_icon-5.png') }}" alt="">
                                        ...
                                        <div class="listing__item__text">
                                            ...
                                            <div class="listing__item__text__info">
                                                <div class="listing__item__text__info__left">
                                                    <img src="{{ asset('template/img/listing/list_small_icon-4.png') }}" alt="">
                                                    <span>Shopping</span>
                                                </div>
                                                <div class="listing__item__text__info__right">Open Now</div>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="listing__item">
                                        <div class="listing__item__pic set-bg"
                                        data-setbg="{{ asset('template/img/listing/list-6.jpg') }}">
                                            <img src="{{ asset('template/img/listing/list_icon-6.png') }}" alt="">
                                            <div class="listing__item__pic__tag">Popular</div>
                                            <div class="listing__item__pic__btns">
                                                <a href="#"><span class="icon_zoom-in_alt"></span></a>
                                                <a href="#"><span class="icon_heart_alt"></span></a>
